...
// CODE HERE
var myFriends = ["Noah","Emanuel","Gibbie","Nehemiah"];

// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE
myFriends.push("Grace");
...
function evensOnly() {
  // CODE HERE
  var evensArray = myNumbers.filter(function(num){
    return num%2 === 0;
  })
  return evensArray;
}
...
var trueFriends = peopleIknow.filter(function(num,i){
